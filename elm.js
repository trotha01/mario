...
Elm.Main.make = function (_elm) {
   ...
   var input = function () {
      ...
      delta,
      $Keyboard.arrows);
      return A2($Signal.sampleOn,delta,deltaArrows);
   }();
   var display = F2(function (address,model) {
      var _p0 = {ctor: "_Tuple2"
                ,_0: $Basics.toFloat(model.screenWidth)
                ,_1: $Basics.toFloat(model.screenHeight)};
      var w = _p0._0;
      var h = _p0._1;
      var groundY = 62 - h / 2;
      var mario = model.mario;
      var verb = _U.cmp(mario.y,0) > 0 ? "jump" : !_U.eq(mario.vx,
      0) ? "walk" : "stand";
      var dir = function () {
         var _p1 = mario.dir;
         if (_p1.ctor === "Left") {
      ...
      _U.list([A2($Graphics$Collage.filled,
              ...
              ,A2($Graphics$Collage.move,
              {ctor: "_Tuple2",_0: mario.x,_1: mario.y + groundY},
   ...
   var gravity = F2(function (dt,mario) {
      return _U.update(mario,
      {vy: _U.cmp(mario.y,0) > 0 ? mario.vy - dt / 4 : 0});
   });
   var jump = F2(function (keys,mario) {
      return _U.cmp(keys.y,0) > 0 && _U.eq(mario.vy,
      0) ? _U.update(mario,{vy: 6.0}) : mario;
   });
   ...
   var step = F2(function (action,model) {
      ...
      if (_p2.ctor === "Input") {
            ...
            return {ctor: "_Tuple2"
                   ...
                   {mario: A2(physics,
                   _p3,
                   A2(walk,_p4,A2(jump,_p4,A2(gravity,_p3,model.mario))))})
                   ,_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2"
                   ,_0: _U.update(model,
                   {screenWidth: A2($Debug.log,"w",_p2._0._0)
                   ,screenHeight: A2($Debug.log,"h",_p2._0._1)})
                   ,_1: $Effects.none};
         }
   });
   var app = function () {
      ...
      return $StartApp.start({init: {ctor: "_Tuple2"
                                    ...
                                    ,_1: $Effects.none}
                             ,update: step
                             ,view: F2(function (a,m) {
                                return $Html.fromElement(A2(display,a,m));
                             })
                             ,inputs: _U.list([A2($Signal.map,
                                              WindowResize,
                                              $Window.dimensions)
                                              ,A2($Signal.map,Input,input)])});
   }();
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",
   app.tasks);
   var Mario = F5(function (a,b,c,d,e) {
      return {x: a,y: b,vx: c,vy: d,dir: e};
   });
   var Model = F3(function (a,b,c) {
      return {mario: a,screenWidth: b,screenHeight: c};
   });
